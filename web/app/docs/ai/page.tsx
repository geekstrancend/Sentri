    ...
    <DocsShell pageTitle="AI Co-Auditor">
      <article className="space-y-12">
        ...
        <div>
          ...
          <p className="text-body-lg text-outline leading-7">
        ...
        <div className="bg-surface-container-low border border-outline-variant rounded-lg p-8">
          <div className="grid grid-cols-3 gap-4 items-center">
            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 text-center">
              ...
              <p className="text-label-sm text-on-surface mb-2">1. LIBRARY</p>
            ...
            <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 text-center">
              ...
              <p className="text-label-sm text-on-surface mb-2">2. HITS</p>
              <p className="text-body-md text-outline text-sm">
            ...
            {/* Step 3 */}
            <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-6 text-center col-span-1">
              <div className="flex justify-center mb-4">
                <Cpu size={32} className="text-high" />
              </div>
              <p className="text-label-sm text-on-surface mb-2">3. AI ENRICHMENT</p>
              <p className="text-body-md text-outline text-sm">
        ...
        <Callout type="info" title="PRO TIP">
          ...
          <code className="bg-surface-container border border-outline-variant text-secondary px-1.5 py-0.5 rounded font-mono text-xs">
            SENTRI.md
          </code>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-surface-container-low border-b border-outline-variant">
                  <th className="text-label-sm text-outline text-left px-6 py-3">Feature</th>
                  <th className="text-label-sm text-outline text-left px-6 py-3">Without AI</th>
                  <th className="text-label-sm text-outline text-left px-6 py-3">With AI Co-Auditor</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-outline-variant">
                <tr className="hover:bg-surface-container-low transition-colors">
                  <td className="text-body-md text-on-surface px-6 py-4">Logic Flaw Detection</td>
                  <td className="text-body-md text-outline px-6 py-4">Pattern-based only</td>
                  <td className="text-body-md text-low font-[600] px-6 py-4">Reasoning-based discovery</td>
                </tr>
                <tr className="hover:bg-surface-container-low transition-colors">
                  <td className="text-body-md text-on-surface px-6 py-4">False Positive Rate</td>
                  <td className="text-body-md text-outline px-6 py-4">High (Manual triage req.)</td>
                  <td className="text-body-md text-low font-[600] px-6 py-4">Low (80% noise reduction)</td>
                </tr>
                <tr className="hover:bg-surface-container-low transition-colors">
                  <td className="text-body-md text-on-surface px-6 py-4">Inferred Invariants</td>
                  <td className="text-body-md text-outline px-6 py-4">None</td>
  ...
  chat_enabled: true`}
        ...
        <div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-fraunces text-lg font-[500] text-on-surface mb-2">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 ml-4">
                <li className="text-body-md text-outline">
